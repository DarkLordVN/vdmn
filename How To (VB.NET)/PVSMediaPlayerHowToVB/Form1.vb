...
#Region "Main"
    ...
    Public Sub New()
        ...
        ' Check if Media Foundation and supported Windows version is installed - PVS.MediaPlayer cannot be used without.
        If Not Player.MFPresent Then

            ' Media Foundation is not installed or unsupported Windows version - show a message and exit the application
            MessageBox.Show("PVS.MediaPlayer cannot be used on this computer." + vbNewLine + vbNewLine +
        ...
        ' The shape of a player's video or display can be changed from the usual rectangular shape
        ...
        AddHandler Panel2.MouseDown, AddressOf myPlayer.Display.Drag_MouseDown
        AddHandler Panel3.MouseDown, AddressOf myPlayer.Display.Drag_MouseDown
        ...
        ' or to Nothing: myPlayer.Overlay.Window = Nothing (or myPlayer.Overlay.Remove())
        ...
        ' standard interface items such as buttons, labels and panels. See the file Overlay.vb
        ...
        ' Display clones can also have a custom shape, just like the player's display window, for example:
        ...
        '
        '         Case StopReason.Finished ' media has finished playing
        '
        '         Case StopReason.AutoStop ' media is stopped by the player to play next media
        '
        '         Case StopReason.UserStop ' media is stopped with the Player.Stop method
        '
        '         Case StopReason.Error ' media has stopped because an error has occurred
        ' 
        '     End Select
        ' End Sub
    ...
    Private Sub PlayMedia()
        ...
        If (myOpenFileDlg.ShowDialog() = DialogResult.OK) Then
            ...
            Else
                ...
                If myPlayer.Has.AudioOnly Then
