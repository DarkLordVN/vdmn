namespace PVSMediaPlayerHowTo
{
    partial class Overlay
    {
        ...
        private void InitializeComponent()
        {
			...
			this.subtitlesLabel.ForeColor = System.Drawing.Color.White;
			...
			this.subtitlesLabel.UseCompatibleTextRendering = true;
			// 
			// flashLabel
			// 
			...
			this.flashLabel.UseCompatibleTextRendering = true;
			// 
			// Overlay
			// 
